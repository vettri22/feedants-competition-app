...
const CompetitionDetail = lazy(() => import("./pages/app/CompetitionDetail.tsx"));
const CompetitionsList = lazy(() => import("./pages/app/CompetitionsList.tsx"));
        ...
        <LanguageProvider>
          <BrowserRouter>
            ...
            <Suspense fallback={<RouteLoading />}>
              ...
              <Route
                path="/auth"
                element={<AuthPage redirectAfterAuth="/app/home" />}
              />
              <Route
                path="/app/home"
                element={
              ...
              />
              <Route
                path="/app/competitions/:idOrSlug"
                element={
                  <RequireAuth>
                    <CompetitionDetail />
                  </RequireAuth>
